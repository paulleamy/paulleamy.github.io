...
if (navigator.mediaDevices.getUserMedia) {
  ...
  let onSuccess = function(stream) {
    ...
    mediaRecorder.onstop = function(e) {
      ...
      const clipName = prompt('Enter a name for your sound clip?','My unnamed clip of 30s');
...
//       clipContainer.appendChild(uploadButton);
      ...
      // This may be useful - https://stackoverflow.com/questions/60431835/how-to-convert-a-blob-url-to-a-audio-file-and-save-it-to-the-server
